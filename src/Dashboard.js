    ...
    <div className="dashboard-container">
      ...
      <div className="projects-container">
        <div className="search-bar">
          ...
          <div>
            <h2>Let's Create Some <b>Videos!</b></h2>
          </div>
        ...
        <div className="video-header">
          <p> Start with Popular Templates</p>
           ...
           <div className="template-images">
             <img src={require('./Images/1.jpg')} alt="Template 1" />
             <img src={require('./Images/2.jpg')} alt="Template 2" />
             <img src={require('./Images/3.jpg')} alt="Template 3" />
             <img src={require('./Images/4.jpg')} alt="Template 4" />
           </div>
        </div>
